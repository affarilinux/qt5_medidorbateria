...
class SalvarProcessador:
    ...
    def processos_processador_salvar(self):
        ...
        self.ler_banco_data(time_string1,time_str_seg)

        self.commit_banco()
        self.sair_banco()

    def ler_banco_data(self,hor,seg):
        ...
        self.banco_processador_insert(r_s_1,r_s_2)


    def banco_processador_insert(self,chave1,chave2):
        ...
        self.cursorsq.execute(
            """INSERT INTO PROCESSADOR(
                ...
                VALUES (?,?,?)""",(
                    chave2,chave1,self.filtra_calculo_sistema))
